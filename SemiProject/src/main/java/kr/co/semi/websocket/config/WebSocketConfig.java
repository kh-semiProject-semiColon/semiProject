package kr.co.semi.websocket.config;
...
import kr.co.semi.websocket.handler.ChattingWebSocketHandler;
import kr.co.semi.websocket.handler.TestWebSocketHandler;
...
public class WebSocketConfig implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		...
		.setAllowedOriginPatterns("http://localhost/",
								"http://127.0.0.1/",
								"http://220.77.247.195/").withSockJS();
