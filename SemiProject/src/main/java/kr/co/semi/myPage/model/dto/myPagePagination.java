...
public class myPagePagination {
	...
	// 매개변수 생성자
	public myPagePagination(int currentPage, int listCount) {
		super();
	...
	public myPagePagination(int currentPage, int listCount, int limit, int pageSize) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
	 ...
	 * (maxPage, stratPage, endPage, prevPage, nextPage)
	 * 
	 */
	private void calculate() {
		...
		// 페이지 번호 목록이 10개 (pageSize) 씨기 보여질 경우
		...
		// prevPage : "<" 클릭 시 이동할 페이지 목록 중 끝 번호
