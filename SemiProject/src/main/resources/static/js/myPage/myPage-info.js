...
if (profileForm != null) {
  ...
  // const imageSelectBtn = document.querySelector(".image-select-btn"); 이미지 파일 선택 input
  // const removeImageBtn = document.querySelector(".remove-image"); 이미지 삭제 버튼
  ...
  imageSelectBtn.addEventListener("change", () => {
    ...
    if (file) {
      ...
      if (file.size <= MAX_SIZE) {
        // 현재 선택한 파일의 크기가 허용 범위 이내인 경우 (정상인 경우)
