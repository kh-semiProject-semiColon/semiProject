...
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL,'user171@example.com','$2a$10$wgg/RFbolopwblWMSbA8M.7KbACvQvtp6QIeYI/X7DBlsd5WTSB7C',
'징베','01000000000',NULL,NULL,'N','0',SYSDATE,'Y',NULL,'징베');

INSERT INTO "ANNOUNCEMENT"
VALUES(1,'오늘의 공지',SYSDATE,'자습',1,'N',1,NULL);

INSERT INTO "STUDY"
VALUES(1,'오늘밤주인공은','N',5,SYSDATE,1,2,NULL);

INSERT INTO "HIRE_INFO"
VALUES(1,1,'N',SYSDATE,2,NULL,'너도 우리에게 합류해라',1,'월화수',1,'어서오고');
...
READ_COUNT = 13
WHERE STUDY_BOARD_NO = 13;

INSERT INTO "STUDY_RULE"
VALUES(47,'그래그래');
...
COMMENT ON COLUMN "STUDY_BOARD_LIKE"."STUDY_BOARD_NO" IS '게시글번호(PK)';

COMMENT ON COLUMN "STUDY_BOARD_LIKE"."MEMBER_NO" IS '회원고유번호(PK)';
...
ALTER TABLE "STUDY_BOARD_LIKE" ADD CONSTRAINT "PK_STUDY_BOARD_LIKE" PRIMARY KEY (
	"STUDY_BOARD_NO",
	"MEMBER_NO"
);
...
ALTER TABLE "STUDY_BOARD_LIKE" ADD CONSTRAINT "FK_STUDY_BOARD_TO_BOARD_LIKE_1" FOREIGN KEY (
	"STUDY_BOARD_NO"
)
REFERENCES "STUDY_BOARD" (
	"STUDY_BOARD_NO"
...
ALTER TABLE "STUDY_BOARD_LIKE" ADD CONSTRAINT "FK_MEMBER_TO_STUDY_BOARD_LIKE_1" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"MEMBER_NO"
